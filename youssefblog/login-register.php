        ...
        <main class="col-9">
		                  ...
		                  <?php
										if (isset($_GET['message'])) {
											...
											{
											echo '<p style="color:red;text-align:center;font-size:16px">Le deux mots de passe ne correspond pas</p>';
									  	     } 
										} 
						 ...
						 <?php
										if (isset($_GET['message'])) {
											...
											{
											echo '<p style="color:red;text-align:center;font-size:16px"> Inscription réussie , veuillez vous connectez. </p>';
									  	     } 
										} 
                ...
                <div class="tab-pane container-fluid" id="login" role="tabpanel" aria-expanded="false">
                    ...
                    <form action="login-register.php" method="post" class="p-4 row flex-column">
                        ...
                        <div class="form-group col-sm-8 offset-sm-2">
                            ...
                            <input class="form-control" value="" type="email" placeholder="Email" name="email" id="email" required>
                        </div>

                        <div class="form-group col-sm-8 offset-sm-2">
                            <label for="password">Mot de passe</label>
                            <input class="form-control" value="" type="password" placeholder="Mot de passe" name="password" id="password" required >
                        </div>
                ...
                <div class="tab-pane container-fluid active" id="register" role="tabpanel" aria-expanded="true">
                    <form action="login-register.php" method="post" class="p-4 row flex-column">
                        ...
                        <div class="form-group col-sm-8 offset-sm-2">
                            ...
                            <input class="form-control" value="" type="text" placeholder="Prénom" name="firstname" id="firstname" required>
                        </div>
                        <div class="form-group col-sm-8 offset-sm-2">
                            <label for="lastname">Nom de famille</label>
                            <input class="form-control" value="" type="text" placeholder="Nom de famille" name="lastname" id="lastname"required>
                        </div>
                        <div class="form-group col-sm-8 offset-sm-2">
                        ...
                        <div class="form-group col-sm-8 offset-sm-2">
                            ...
                            <input class="form-control" value="" type="password" placeholder="Confirmation du mot de passe" name="password_confirm" id="password_confirm" required>
                        </div>
                        <div class="form-group col-sm-8 offset-sm-2">
                            <label for="bio">Biographie</label>
                            <textarea class="form-control" name="bio" id="bio" placeholder="Ta vie Ton oeuvre..." required></textarea>
                        </div>

                        <div class="text-right col-sm-8 offset-sm-2">
                            <p class="text-danger">* champs requis</p>
                            <input class="btn btn-success" type="submit" name="register" value="Valider" required>
                        </div>
