            ...
            <table class="table table-striped">
                ...
                <tr>
                    <!-- htmlentities sert à écrire les balises html sans les interpréter -->
					   ...
					   <th><?php echo $LISTE['name'];?></th>
					   <th><?php echo $LISTE['description'];?></th>
                   
					</td>
                    <td>
                        <a href="category_form_update.php?user_id=<?php echo $LISTE['id']; ?>" class="btn btn-warning">Modifier</a>
                        <a onclick="return confirm('Voulez vous vraiment supprimer <?php echo $LISTE['name'];?> ?')" href="delete_category.php?id=<?php echo $LISTE['id']; ?>" class="btn btn-danger">Supprimer</a>
                    </td>
                </tr>
